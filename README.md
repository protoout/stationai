...
- `0.` [ハンズオンの前に（10 min　/ 10 min）](00.md)
    - ハンズオン準備（10 min / 10 min）
        - [事前準備資料](https://gist.github.com/n0bisuke/13a25255d4230ead770d73c47247a2fb)の確認

## ハンズオン / 制作

- ハンズオン前半
    - `1.` [Manusで天気予報アプリの雛形を作成し、スマホで動かす（20 min / 40 min）](01.md)

> 10分間休憩

- ハンズオン後半
    - `2.` [バイブコーディングの準備を整える（30 min / 80 min）](02.md)
    - `3.` [バイブコーディングでアプリに機能を追加する（30 min / 110 min）](03.md)

- 応用制作
    - `4.` [応用制作・発表（55 min / 175 min）](04.md)
