...
> Manusは万人に使える親切な環境（その分お金がかかる）でしたが、ここからは実際のエンジニアと呼ばれる職種の人も利用する環境です.  
> 1文字の誤りで動かないことも発生しますので、**書いてある手順を遵守する**、**コピペできるところはコピペする**ということを再度意識しましょう
...
- このRepositoryでCodespaceを立ち上げます
- 緑色の`< > Code ▼`ボタンを押し、続けて`Create codespace on main`を押すとCodespaceが立ち上げります
...
> この後、ターミナルを利用するので待っている間、使い方を少し復習しておいてください

- 立ち上げていると、次のような警告が出るかもしれませんが`今後表示しない`を押してしまって構いません
